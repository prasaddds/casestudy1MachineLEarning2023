# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 16:04:02 2023
...
# Handling outliers and missing values without dropping rows
celeba_data[target_column] = celeba_data[target_column].apply(lambda x: x if x in [-1, 1] else pd.NA)

# Fill missing values with -1
celeba_data[target_column].fillna(-1, inplace=True)
...
output_file_path = r'C:\Users\patala durga prasad\Desktop\machine_learning_project\archive (1)\celeba_encoded_outliers_handled.xlsx'
